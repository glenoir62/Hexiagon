...
public class AnnouncementClp extends BaseModelImpl<Announcement>
    ...
    public java.util.List<com.gleo.plugins.hexiagon.model.AnnouncementImage> getImages() {
        try {
            ...
            java.util.List<com.gleo.plugins.hexiagon.model.AnnouncementImage> returnObj =
                (java.util.List<com.gleo.plugins.hexiagon.model.AnnouncementImage>) invokeOnRemoteModel(methodName,
                    parameterTypes, parameterValues);
    ...
    public com.gleo.plugins.hexiagon.model.Type getType() {
        try {
            ...
            com.gleo.plugins.hexiagon.model.Type returnObj = (com.gleo.plugins.hexiagon.model.Type) invokeOnRemoteModel(methodName,
                    parameterTypes, parameterValues);
    ...
    public com.gleo.plugins.hexiagon.model.AnnouncementImage getImage() {
        try {
            ...
            com.gleo.plugins.hexiagon.model.AnnouncementImage returnObj = (com.gleo.plugins.hexiagon.model.AnnouncementImage) invokeOnRemoteModel(methodName,
                    parameterTypes, parameterValues);
