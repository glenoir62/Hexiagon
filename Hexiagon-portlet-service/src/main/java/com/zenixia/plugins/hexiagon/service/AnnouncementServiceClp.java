...
public class AnnouncementServiceClp implements AnnouncementService {
    ...
    public AnnouncementServiceClp(InvokableService invokableService) {
        ...
        _methodName4 = "updateAnnouncement";
        ...
        _methodName5 = "deleteAnnouncement";

        _methodParameterTypes5 = new String[] { "long" };

        _methodName6 = "getAnnouncement";

        _methodParameterTypes6 = new String[] { "long" };

        _methodName7 = "getAnnouncementsByGroupId";

        _methodParameterTypes7 = new String[] { "long", "int", "int" };

        _methodName8 = "getAnnouncementsCountByGroupId";
    ...
    public com.zenixia.plugins.hexiagon.model.Announcement addAnnouncement(
        ...
        return (com.zenixia.plugins.hexiagon.model.Announcement) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.zenixia.plugins.hexiagon.model.Announcement deleteAnnouncement(
        ...
        try {
            returnObj = _invokableService.invokeMethod(_methodName5,
                    _methodParameterTypes5, new Object[] { announcementId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.zenixia.plugins.hexiagon.model.Announcement getAnnouncement(
        ...
        try {
            returnObj = _invokableService.invokeMethod(_methodName6,
                    _methodParameterTypes6, new Object[] { announcementId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.zenixia.plugins.hexiagon.model.Announcement> getAnnouncementsByGroupId(
        ...
        return (java.util.List<com.zenixia.plugins.hexiagon.model.Announcement>) ClpSerializer.translateOutput(returnObj);
    }
