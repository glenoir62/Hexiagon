...
public class CurrencyUtil {
    ...
    */
    public static void cacheResult(
        java.util.List<com.zenixia.plugins.hexiagon.model.Currency> currencies) {
    ...
    */
    public static com.zenixia.plugins.hexiagon.model.Currency create(
        long currencyId) {
    ...
    * @throws com.zenixia.plugins.hexiagon.NoSuchCurrencyException if a currency with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static com.zenixia.plugins.hexiagon.model.Currency remove(
        long currencyId)
    ...
    public static com.zenixia.plugins.hexiagon.model.Currency updateImpl(
        com.zenixia.plugins.hexiagon.model.Currency currency)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    /**
    * Returns the currency with the primary key or throws a {@link com.zenixia.plugins.hexiagon.NoSuchCurrencyException} if it could not be found.
    *
    * @param currencyId the primary key of the currency
    * @return the currency
    * @throws com.zenixia.plugins.hexiagon.NoSuchCurrencyException if a currency with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static com.zenixia.plugins.hexiagon.model.Currency findByPrimaryKey(
        long currencyId)
        throws com.liferay.portal.kernel.exception.SystemException,
            com.zenixia.plugins.hexiagon.NoSuchCurrencyException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.zenixia.plugins.hexiagon.model.Currency fetchByPrimaryKey(
        long currencyId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.zenixia.plugins.hexiagon.model.Currency> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static CurrencyPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (CurrencyPersistence) PortletBeanLocatorUtil.locate(com.zenixia.plugins.hexiagon.service.ClpSerializer.getServletContextName(),
