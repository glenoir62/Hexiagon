...
public class TypeLocalServiceClp implements TypeLocalService {
    ...
    public TypeLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName20 = "getTypes";

        _methodParameterTypes20 = new String[] { "long", "int", "int" };

        _methodName21 = "getTypesCount";
    ...
    public com.zenixia.plugins.hexiagon.model.Type addType(
        ...
        return (com.zenixia.plugins.hexiagon.model.Type) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.zenixia.plugins.hexiagon.model.Type> getTypes(
        ...
        return (java.util.List<com.zenixia.plugins.hexiagon.model.Type>) ClpSerializer.translateOutput(returnObj);
    }
