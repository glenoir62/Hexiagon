...
/**
 * Provides the local service interface for AnnouncementImage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author guillaumelenoir
 * @see AnnouncementImageLocalServiceUtil
...
public interface AnnouncementImageLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link AnnouncementImageLocalServiceUtil} to access the announcement image local service. Add custom service methods to {@link com.zenixia.plugins.hexiagon.service.impl.AnnouncementImageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
