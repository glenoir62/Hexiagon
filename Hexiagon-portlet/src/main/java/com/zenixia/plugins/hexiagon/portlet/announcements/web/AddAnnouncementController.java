...
import com.zenixia.plugins.hexiagon.validator.AnnouncementValidator;
...
public class AddAnnouncementController extends MVCPortlet {
	...
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		try {
			preferences = PortletPreferencesLocalServiceUtil.getPreferences(themeDisplay.getCompanyId(), PortletKeys.PREFS_OWNER_ID_DEFAULT, PortletKeys.PREFS_OWNER_TYPE_LAYOUT, PortalUtil.getControlPanelPlid(themeDisplay.getCompanyId()), com.zenixia.plugins.hexiagon.constants.PortletKeys.HEXAGON_PORTLETID);
