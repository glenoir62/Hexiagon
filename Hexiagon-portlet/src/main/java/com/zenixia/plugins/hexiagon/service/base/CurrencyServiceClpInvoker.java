...
public class CurrencyServiceClpInvoker {
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName44.equals(name) &&
            ...
            return CurrencyServiceUtil.addCurrency((com.zenixia.plugins.hexiagon.model.Currency) arguments[0],
                (com.liferay.portal.service.ServiceContext) arguments[1]);
        }

        if (_methodName45.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes45, parameterTypes)) {
            return CurrencyServiceUtil.updateCurrency((com.zenixia.plugins.hexiagon.model.Currency) arguments[0]);
        }
