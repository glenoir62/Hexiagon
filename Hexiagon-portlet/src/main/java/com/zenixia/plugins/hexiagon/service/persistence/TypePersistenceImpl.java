...
import com.zenixia.plugins.hexiagon.NoSuchTypeException;
import com.zenixia.plugins.hexiagon.model.Type;
import com.zenixia.plugins.hexiagon.model.impl.TypeImpl;
import com.zenixia.plugins.hexiagon.model.impl.TypeModelImpl;
...
public class TypePersistenceImpl extends BasePersistenceImpl<Type>
    ...
    @Override
    public Type updateImpl(com.zenixia.plugins.hexiagon.model.Type type)
        throws SystemException {
        type = toUnwrappedModel(type);
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.zenixia.plugins.hexiagon.model.Type")));
