 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.gleo.plugins.hexiagon.model.TypeModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link TypeImpl}.
 * </p>
 *
 * @author guillaumelenoir
 * @see TypeImpl
 * @see com.gleo.plugins.hexiagon.model.Type
 * @see com.gleo.plugins.hexiagon.model.TypeModel
 * @generated
 */
@JSON(strict = true)
public class TypeModelImpl extends BaseModelImpl<Type> implements TypeModel {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a type model instance should use the {@link com.gleo.plugins.hexiagon.model.Type} interface instead.
     */
