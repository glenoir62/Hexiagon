...
import com.gleo.plugins.hexiagon.model.AnnouncementImageModel;
...
/**
 * The base model implementation for the AnnouncementImage service. Represents a row in the &quot;Hexiagon_AnnouncementImage&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.gleo.plugins.hexiagon.model.AnnouncementImageModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AnnouncementImageImpl}.
 * </p>
 *
 * @author guillaumelenoir
 * @see AnnouncementImageImpl
 * @see com.gleo.plugins.hexiagon.model.AnnouncementImage
 * @see com.gleo.plugins.hexiagon.model.AnnouncementImageModel
 * @generated
 */
public class AnnouncementImageModelImpl extends BaseModelImpl<AnnouncementImage>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a announcement image model instance should use the {@link com.gleo.plugins.hexiagon.model.AnnouncementImage} interface instead.
     */
    public static final String TABLE_NAME = "Hexiagon_AnnouncementImage";
    ...
    public static final String TABLE_SQL_CREATE = "create table Hexiagon_AnnouncementImage (announcementImageId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,announcementId LONG,fileEntryId LONG,description STRING null,order_ INTEGER)";
    public static final String TABLE_SQL_DROP = "drop table Hexiagon_AnnouncementImage";
    public static final String ORDER_BY_JPQL = " ORDER BY announcementImage.order ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Hexiagon_AnnouncementImage.order_ ASC";
    public static final String DATA_SOURCE = "liferayDataSource";
    public static final String SESSION_FACTORY = "liferaySessionFactory";
    public static final String TX_MANAGER = "liferayTransactionManager";
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.com.gleo.plugins.hexiagon.model.AnnouncementImage"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.com.gleo.plugins.hexiagon.model.AnnouncementImage"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.com.gleo.plugins.hexiagon.model.AnnouncementImage"),
            true);
    public static long ANNOUNCEMENTID_COLUMN_BITMASK = 1L;
    public static long ORDER_COLUMN_BITMASK = 2L;
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.com.gleo.plugins.hexiagon.model.AnnouncementImage"));
    private static ClassLoader _classLoader = AnnouncementImage.class.getClassLoader();
